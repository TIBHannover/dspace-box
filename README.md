...
**ATTENTION**: THIS IS A DRAFT - THE INSTALLATION VIA ANSIBLE IS NOT FINISHED YET!
...
**NOTE**: DSpace 7 is still a Beta version and under active development. It is not recommended to install it in production!
